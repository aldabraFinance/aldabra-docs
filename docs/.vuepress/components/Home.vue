<template lang="pug">
  div
    ...
    .h2 Getting Started
    .p__alt Read all about the Aldabra Master Plan.
    .features
      router-link(to="/getting-started/introduction").features__item.features__item__light
        .features__item__image
          icon-aldabra.features__item__image__img
      ...
      router-link(to="/getting-started/roadmap").features__item.features__item__dark
        ...
        .features__item__text
          .features__item__text__h2 read
          .features__item__text__h1 Roadmap
          .features__item__text__p Keep track of previous releases and upcoming developments to the Aldabra Finance.
    .sections__wrapper
      .h2 Explore
      .p__alt Get familiar with the Aldabra ecosystem and explore our protocol.
      .sections
...
.features {
  ...
  &__item {
    ...
    background: linear-gradient(302.07deg, #FFFFFF 48.96%, #EBF5FF 100%);
    outline: none;
